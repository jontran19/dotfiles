...
if !has('gui_running') && get(g:, "wwdc16_term_trans_bg", 0)
  hi Normal ctermfg=15 ctermbg=235 cterm=NONE guifg=#ffffff guibg=NONE gui=NONE
else
  hi Normal ctermfg=15 ctermbg=235 cterm=NONE guifg=#ffffff guibg=#292c36 gui=NONE
endif
...
hi DiffAdd ctermfg=34 ctermbg=0 cterm=NONE,reverse guifg=#95c76f guibg=#292c36 gui=NONE,reverse guisp=NONE
hi DiffChange ctermfg=8 ctermbg=15 cterm=NONE,reverse guifg=#d28e5d guibg=#ffffff gui=NONE,reverse guisp=NONE
hi DiffDelete ctermfg=1 ctermbg=15 cterm=NONE,reverse guifg=#dc3c3c guibg=#ffffff gui=NONE,reverse guisp=NONE
hi DiffText ctermfg=98 ctermbg=15 cterm=NONE,bold,reverse guifg=#52bd58 guibg=#ffffff gui=NONE,bold,reverse guisp=NONE
...
hi Foed ctermfg=9 ctermbg=NONE cterm=NONE guifg=#666666 guibg=NONE gui=NONE guisp=NONE
hi IncSearch ctermfg=20 ctermbg=15 cterm=NONE,reverse guifg=#00afaf guibg=#875f00 gui=NONE,standout guisp=NONE
...
hi NonText ctermfg=15 ctermbg=235 cterm=NONE guifg=#ffffff guibg=NONE gui=NONE guisp=NONE
...
hi Comment ctermfg=38 ctermbg=NONE cterm=NONE guifg=#999999 guibg=NONE gui=NONE,italic guisp=NONE
...
hi Todo ctermfg=124 ctermbg=NONE cterm=NONE,bold guifg=#b73999 guibg=NONE gui=NONE,bold guisp=NONE
