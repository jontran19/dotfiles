...
if exists("syntax_on")
    ...
    hi Normal guifg=slategray2 guibg=#708090 ctermfg=14
       ...
       if exists("b:semicolon")
             unlet b:semicolon
	           hi semicolon guifg=NONE gui=NONE ctermfg=NONE
		            ...
		            syn match semicolon #;$#
			          hi semicolon guifg=red2 gui=bold ctermfg=1
				        let b:semicolon = 1
					   endif
					   endfunction
					   "}}}
					   ...
					   hi DiffChange guibg=steelblue2 guifg=bg gui=NONE
					   hi DiffDelete guibg=slategray4 guifg=slategray2
					   hi DiffText guibg=steelblue4 gui=bold
					   hi ErrorMsg guibg=red2 ctermfg=1
					   "hi VertSplit
					   hi Folded guibg=#00001a guifg=yellow2 ctermbg=4 ctermfg=11 gui=NONE
					   hi FoldColumn guibg=steelblue2 ctermbg=14 guifg=navyblue ctermfg=11 gui=bold
					   "hi SignColumn
					   "hi IncSearch
					   hi LineNr guifg=yellow2 ctermfg=3
					   hi MatchParen guibg=navyblue gui=italic
					   hi ModeMsg guifg=yellow2 gui=bold ctermfg=3
					   "hi MoreMsg(   )
					   "hi NonText
					   hi Pmenu guibg=steelblue2 guifg=bg ctermfg=7 ctermbg=4 cterm=bold
					   hi PmenuSel guibg=fg guifg=bg gui=bold ctermfg=4 ctermbg=7 cterm=bold
					   hi link PmenuSbar Pmenu
					   "hi PmenuThumb
					   "hi Question
					   hi Search guibg=yellow2 guifg=bg
					   "hi SpecialKey
					   "hi SpellBad
					   "hi SpellCap
					   "hi SpellLocal
					   "hi SpellRare
					   hi StatusLine guifg=steelblue2
					   ...
					   hi Comment guifg=chartreuse2 ctermfg=10
					   hi Constant guifg=plum2 gui=bold ctermfg=12
					   hi String guifg=indianred2 ctermfg=5
					   hi Character guifg=mediumpurple2 ctermfg=5
					   hi Number guifg=turquoise2 ctermfg=5
					   "hi Identifier
					   hi Statement guifg=khaki2 gui=bold ctermfg=15 cterm=underline
					   hi PreProc guifg=firebrick2 gui=italic ctermfg=9
					   hi Type  guifg=gold2 gui=bold ctermfg=3
					   hi Special guifg=orange ctermfg=208
					   hi Underlined ctermfg=white cterm=underline
					   "hi Ignore
					   "hi Error
					  " hi Todo guifg=yellow2 guibg=blue2 gui=bold ctermfg=3
